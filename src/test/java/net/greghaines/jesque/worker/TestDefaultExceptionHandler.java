...
public class TestDefaultExceptionHandler {
    ...
    public void testOnException_ConnectionEx() {
        Assert.assertEquals(RecoveryStrategy.RECONNECT, new DefaultExceptionHandler()
                .onException(null, new JedisConnectionException("foo"), null));
    }

    @Test
    public void testOnException_JsonEx() {
        Assert.assertEquals(RecoveryStrategy.PROCEED, new DefaultExceptionHandler()
    ...
    public void testOnException_Interrupted() {
        ...
        Assert.assertEquals(RecoveryStrategy.PROCEED, new DefaultExceptionHandler()
                .onException(jobEx, new InterruptedException("foo"), null));
    ...
    public void testOnException_InterruptedShutdown() {
        ...
        Assert.assertEquals(RecoveryStrategy.TERMINATE, new DefaultExceptionHandler()
                .onException(jobEx, new InterruptedException("foo"), null));
        mockCtx.assertIsSatisfied();
    }
