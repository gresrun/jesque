...
public class TestExceptionSerialization {
  ...
  public void testDeseralize() throws Exception {
    final String payload =
        """
        {
          "worker": "test5:12385-1:JAVA_DYNAMIC_QUEUES,SomeQueue",
          "queue": "audioTranscode",
          "payload": {
            "class": "SomeClass",
            "args": [1234]
          },
          ...
          "error": "SomeError",
          "backtrace": [" at sompackage.someclass(somefile.java:42)"],
          "failed_at": "2011-10-17T18:01:33.185+0000",
          "retried_at": null
        }
        """;
