...
public class TestReflectionUtils {
    ...
    @Test
    public void testCreateObject_NoArgs_NoVars() throws NoSuchConstructorException,
    ...
    @Test
    public void testCreateObject_NoArgs_Vars() throws NoSuchConstructorException,
            AmbiguousConstructorException, ReflectiveOperationException {
        final Map<String, Object> vars = new HashMap<String, Object>();
        vars.put("intVal", 1);
        vars.put("floatVal", 2.3f);
    ...
    @Test
    public void testCreateObject_Args_NoVars() throws NoSuchConstructorException,
            AmbiguousConstructorException, ReflectiveOperationException {
    ...
    @Test
    public void testCreateObject_EmptyArgs_Vars() throws NoSuchConstructorException,
            AmbiguousConstructorException, ReflectiveOperationException {
        final Map<String, Object> vars = new HashMap<String, Object>();
        vars.put("intVal", 1);
        vars.put("floatVal", 2.3f);
    ...
    public static class SetterObj implements Runnable {
        ...
        public SetterObj(final int intVal, final float floatVal, final String stringVal,
                final Object objVal) {
            this.intVal = intVal;
