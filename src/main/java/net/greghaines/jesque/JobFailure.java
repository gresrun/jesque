...
public class JobFailure implements Serializable {
  ...
  @JsonProperty private String worker;
  @JsonProperty private String queue;
  @JsonProperty private Job payload;
  @JsonIgnore private Throwable throwable;
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((this.throwableString == null) ? 0 : this.throwableString.hashCode());
  ...
  private void tryCreateThrowable() {
    if (this.throwable == null
      ...
      try {
        this.throwable =
            JesqueUtils.recreateThrowable(this.throwableString, this.error, this.backtrace);
      } catch (Exception e) {
        LOG.warn(
            "Error while recreating throwable: "
                + this.throwableString
                + " "
                + this.error
                + " "
                + this.backtrace,
