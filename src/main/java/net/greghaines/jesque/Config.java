...
public final class Config {
    ...
    public String getURI() {
        return "redis://" + this.hostAndPort.getHost() + ":" + this.hostAndPort.getPort() + "/"
    ...
    public static class Builder {
         ...
         * 
         * <p>
         * Clients created from this config will not use sentinels.
         *
         ...
         * 
         * <p>
         * Clients created from this config will not use hostname and port.
         *
         * @param masterName the Redis master name
         * @param sentinels the set of Redis sentinel hostnames and ports
         * @return this Builder
         */
        public Builder withMasterNameAndSentinels(final String masterName,
