...
public interface FailQueueStrategy {
    ...
    /**
     * Determine the key for the failure queue. A null return value is an indication that no failure
     * queue is needed. Note that the default implementation (@see DefaultFailQueueStrategy) will
     * never return null.
     * 
    ...
    /**
     * Determine the max number of items to keep in the failure queue. Returning a value less than 1
