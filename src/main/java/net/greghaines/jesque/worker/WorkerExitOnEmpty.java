 ...
 * <p/>
 * This is useful if you have more queues that you want active workers for at one time, and you 
 * don't want workers working multiple queues.
 * <p/>
 * Essentially once a worker starts a queue you want that queue worked to exhaustion, then you 
 * want that worker to die, and to start up another worker on a new queue.
 * 
