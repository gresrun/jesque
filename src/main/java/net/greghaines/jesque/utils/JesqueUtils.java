...
public final class JesqueUtils {
  ...
  /**
   * Recreate an exception from a type name, a message and a backtrace (created from <code>
   * JesqueUtils.createBacktrace(Throwable)</code>).
   *
   ...
   *       single String as it's only parameter.
   *   <li>If the message is non-null and the cause is non-null, there must be a Constructor with a
   *       single String as it's only parameter or a Constructor with a String and a Throwable as
   *       its parameters.
   *   <li>If the message is null and the cause is null, there must be either a no-arg Constructor
   *       or a Constructor with a single String as it's only parameter.
   *   <li>If the message is null and the cause is non-null, there must be either a no-arg
   *       Constructor, a Constructor with a single String as its only parameter or a Constructor
   *       with a String and a Throwable as its parameters.
   * </ul>
   *
   ...
   * @throws NoSuchConstructorException if there is not a common constructor available for the given
   *     type
   ...
   */
  public static Throwable recreateThrowable(
      final String type, final String message, final List<String> backtrace)
  ...
  protected static Throwable instantiateThrowable(
      final String type,
