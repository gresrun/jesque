...
public interface AdminClient {
  ...
  /**
   * Send a shutdown command on the {@link
   * net.greghaines.jesque.utils.ResqueConstants#ADMIN_CHANNEL} channel.
   *
  ...
  /**
   * Send a pause command on the {@link net.greghaines.jesque.utils.ResqueConstants#ADMIN_CHANNEL}
   * channel.
   *
   * @param paused if true, the workers will not process any new jobs; if false, the workers will
   *     process new jobs
   */
  ...
  /**
   * Publishes a job on the {@link net.greghaines.jesque.utils.ResqueConstants#ADMIN_CHANNEL}
   * channel.
   *
