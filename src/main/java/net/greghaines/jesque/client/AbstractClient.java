...
public abstract class AbstractClient implements Client {
     ...
     * @param   lockHolder  a unique string used to tell if you are the current holder of a lock for both acquisition, and
     *                      extension
     *
     * @return  Whether or not the lock was acquired.
     */
    protected abstract boolean doAcquireLock(final String lockName, final String lockHolder, final Integer timeout) throws Exception;
     ...
     * @return  Whether or not the lock was acquired.
     */
    public static boolean doAcquireLock(final Jedis jedis, final String namespace, final String lockName, final String lockHolder,
        Integer timeout) {
