...
public interface Client {
  ...
  /**
   * Queues jobs in a given queue to be run. Consider splitting long lists of jobs into chunks of
   * 10,000 or so.
   *
   * @param queue the queue to add the Job to
   * @param jobs the jobs to be enqueued
   * @throws IllegalArgumentException if the queue is null or empty or if the list of jobs is null
   * @see <a href="https://redis.io/topics/pipelining">Redis Pipelining</a>
   * @see <a href="https://redis.io/topics/pipelining#redis-pipelining">Important Note: Split at 10k
   *     jobs</a>
   */
   ...
   *
   * @param queue the queue to remove the Job from
